...
for filename in __pycache__ venv .gitignore vulhubmanagement.sh vulnerability src Dockerfile-composer Dockerfile-shell Dockerfile-web docker-compose-dev.yml 
do
